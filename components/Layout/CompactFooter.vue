<template>
  <footer class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200">
    ...
    <UModal v-model="aboutModalOpen">
      <UCard>
        <template #header>About World of Nuclear</template>
        <div>
          <div class="mb-4">World of Nuclear is a platform for nuclear enthusiasts and professionals. It is a place to
